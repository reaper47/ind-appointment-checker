...
func TestBiometrics(t *testing.T) {
	t.Run("all cities", func(t *testing.T) {
		...
		want := []models.URL{
			...
			{
				City:       models.ExpatNijmegen,
				Endpoint:   "/0d85a757c13105ba0c26c3d177a7a884/slots/?productKey=BIO&persons=1",
				ProductKey: "BIO",
				Persons:    1,
			},
		}
...
func TestResidenceSticker(t *testing.T) {
	t.Run("all cities", func(t *testing.T) {
		...
		want := []models.URL{
			...
			{
				City:       models.ExpatNijmegen,
				Endpoint:   "/0d85a757c13105ba0c26c3d177a7a884/slots/?productKey=VAA&persons=1",
				ProductKey: "VAA",
				Persons:    1,
			},
		}
...
func TestResidence(t *testing.T) {
	t.Run("all cities", func(t *testing.T) {
		...
		want := []models.URL{
			...
			{
				City:       models.ExpatNijmegen,
				Endpoint:   "/0d85a757c13105ba0c26c3d177a7a884/slots/?productKey=DOC&persons=1",
				ProductKey: "DOC",
				Persons:    1,
			},
		}
